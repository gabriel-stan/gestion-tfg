...
class TfgServicesTests(TestCase):
    def setUp(self):
        ...
        self.otro_user_alumn1_tfg = Alumno.objects.create_user(
            username='otro_alumn1', email='otro_alumn1@ugr.es', password='otro_top_secretalumn1')
        self.otro_user_alumn2_tfg = Alumno.objects.create_user(
            username='otro_alumn2', email='otro_alumn2@ugr.es', password='otro_top_secretalumn2')
        self.otro_user_alumn3_tfg = Alumno.objects.create_user(
